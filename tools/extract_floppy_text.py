...
def find_ci(directory, name):
    """大小寫容錯:Elvira2 檔名小寫(gamepc/stripped.txt/text01),stripped 內記大寫。"""
...
def main():
    ...
    gamepc = find_ci(floppy_dir, 'GAMEPC')
    stripped = find_ci(floppy_dir, 'STRIPPED.TXT')
